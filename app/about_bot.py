...
gpt-4o                    0.04$   1000  tok\n\
gpt-4o-mini               0.0015$ 1000  tok\n\
\n\
Бот проверяет курс доллара каждый день и ведет расчет согласно курса, так как токены в OpenAI\
 ...
 посмотреть соотношение цен. К сожалению, автоматическая оплата через карты РФ блокируется, но работает телеграмм) Если у вас не выходит оплатить вы можете написать мне.\n\n\
